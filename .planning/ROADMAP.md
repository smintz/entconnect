...
- [ ] 03-07-PLAN.md — Gap WR-07: the `check-single-validationerror-site` invariant gate, wired into `make`, `scripts/pipeline.sh` and CI the way `check-dep-parity` is, and the test comment that named a nonexistent target corrected
