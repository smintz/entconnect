...
Read and follow `/Users/smintz/go/src/github.com/smintz/entconnect/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
