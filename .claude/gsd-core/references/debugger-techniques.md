...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/go/src/github.com/smintz/entconnect/.claude
                  → checks /Users/smintz/go/src/github.com/smintz/entconnect/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/go/src/github.com/smintz/entconnect/.claude/gsd-core
                  → writes to /Users/smintz/go/src/github.com/smintz/entconnect/.claude/gsd-core/hooks/
