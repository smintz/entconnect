...
```
Agent(
  prompt="Read /Users/smintz/go/src/github.com/smintz/entconnect/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/go/src/github.com/smintz/entconnect/.claude/gsd-core/templates/SECURITY.md`
