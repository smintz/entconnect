...
// This file is the FieldMask-gated update fixture's entc codegen entry
// point, run via go:generate in generate.go — mirrors
// internal/entconnecttest/read/ent/entc.go (02-01) exactly.
package main
