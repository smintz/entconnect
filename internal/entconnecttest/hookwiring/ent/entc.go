...
// This file is the hookwiring fixture's entc codegen entry point, run via
// go:generate in generate.go — mirrors
// internal/entconnecttest/{update,write}/ent/entc.go exactly.
package main
